...
vmap <C-c> "+y	"Visual模式下，复制当前选中内容要vim剪切板和系统剪切板
vmap <C-v> "+p	"Visual模式下，将系统剪切板内容插入到当前位置
nmap <C-c> "+Y	"Normal模式下，复制当前选中内容要vim剪切板和系统剪切板
nmap <C-v> "+P	"Normal模式下，将系统剪切板内容插入到当前位置
"imap <C-c> <Esc>"+Yi	"Insert模式下，复制当前选中内容要vim剪切板和系统剪切板
"imap <C-v> <Esc>"+Pi	"Insert模式下，将系统剪切板内容插入到当前位置
...
"========================"
 ...
 if has("gui_running")
     colorscheme koehler 
     set fileencodings=utf-8,ucs-bom,cp936,cp1250,big5,euc-jp,euc-kr,latin1
"     set guioptions=mtr "只显示菜单和右侧滚动条"
     set guifont=新宋体:h12
